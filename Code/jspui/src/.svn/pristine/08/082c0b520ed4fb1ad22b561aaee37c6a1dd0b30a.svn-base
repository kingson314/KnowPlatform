...
<center>
    <table class="table" summary="Table displaying your subscriptions">
	<tr>
		<th><fmt:message key="jsp.mydspace.subscriptions.info3-rp12"/></th>
		<th><fmt:message key="jsp.mydspace.subscriptions.info3-rp13"/></th>
		<th><fmt:message key="jsp.mydspace.subscriptions.info3-rp14"/></th>
		<th/>
	</tr>
<%
String row = "odd";
