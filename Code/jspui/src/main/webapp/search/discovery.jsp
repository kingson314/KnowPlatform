...
<br/>
<span class="switch-filters" style="display: none;">
...
<h3 class="facets" style="display: none;"><fmt:message key="jsp.search.facet.refine" /></h3>
...
<%
		...
		if(facetGlobalConf!=null) {
		    ...
		    %>
		    <div id="globalFacet" class="facetsBox" style="display: none;">
...
<%
	for (DiscoverySearchFilterFacet facetConf : facetsConf)
	{
	    ...
	    %><div id="facet_<%= f %>" class="panel panel-primary">
