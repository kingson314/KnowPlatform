    ...
    <body>
        ...
        <div id="content">
            ...
            <!--CRIS Module按钮-->
                          ...
                          <li>
                              <img sclass="tb" src="../image/bz.png"/><a  onClick="javascript:document.getElementById('iframe').src='<%= request.getContextPath() %>/cris/administrator/index.htm'"><fmt:message key="jsp.layout.navbar-admin.cris"/></a>
